...
use App\Filament\Pages\ClusterInstances;
use App\Filament\Widgets\ClusterOverview;
...
return [
    ...
    */
    ...
    'custom_permissions' => [
        ...
        'instance.restart' => 'Restart instances',
